...
public class ModBlocks {
      ...
      // ✅ Botellero
      public static final RegistryObject<Block> BOTELLERO = BLOCKS.register("botellero",
                  () -> new BottleRack(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).strength(2f, 1.2f)));
}
